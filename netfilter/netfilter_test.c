        ...
        {//parse TCP header
            ...
            {	// extract and print Host header from HTTP Request
                ...
                if (host_header)
                {
                    ...
                    if (end_of_host)
                    {
                        *end_of_host = '\0'; // end Host header
                        
                       // compare with input and print result
                        if (user_input_host && strcmp(user_input_host, host_header) == 0)
                        {
                            printf("BLOCKED "); // host name == input
                            return NF_DROP;	// block packet
                        }
                    }
                }
            }
...
int main(int argc, char **argv)
{
	...
	user_input_host = argv[1]; //inser user input to global var
